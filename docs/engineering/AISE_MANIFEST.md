...
SOURCE REPOSITORY:     github.com/alexkanga/jourdain.git
SOURCE COMMIT:         2991df51c1fa692f892452c361081c626f028cd0
...
S0 VERSION:            0.4 (patched: added §26 REMOTE RUNTIME COST & QUOTA SAFETY; §27 PRODUCT DELIVERY FIRST & COMPLEXITY BUDGET; §28 DATABASE CONTINUITY & RECONSTRUCTION DOCTRINE)
S0 PATCH DATE:         2026-09-19
S0 PATCH SCOPE:        Added §28 DATABASE CONTINUITY & RECONSTRUCTION DOCTRINE to S0.
                      Updated S0 version 0.3 → 0.4. No application code
                      modified. Cross-cutting database governance doctrine.
...
engineer can answer "What AISE governance version is this project
using?" without chat memory, agent memory, guessing, or branch
archaeology.

The vendored AISE documents are operational: they do not depend on an
external repository to be readable or applicable.
...
All AISE components in this repository were copied from the SAME
verified source commit (2991df51c1fa692f892452c361081c626f028cd0) of
the canonical source repository github.com/alexkanga/jourdain.git.

No AISE component was reconstructed from chat memory, agent
recollection, or an unpushed local state.

No AISE component has been locally modified during installation.

## Secrets

This manifest contains no secrets. No passwords, API tokens, database
URLs, private keys, or production credentials are stored here.
